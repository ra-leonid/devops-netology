...
1. Опишите основные плюсы и минусы pull и push систем мониторинга.
   ...
   1. PUSH:
      1. Плюсы:
         * Настройка репликации данных проще по сравнению с PULL-моделью.
         * Более гибкая настройка клиентов
         * Более производительный сбор метрик
      2. Минусы:
         * Возможна потеря данных
         * Подлинность данных под сомнением
   2. PULL:
      1. Плюсы:
         * Более защищенный и безопасный по сравнению с PUSH.
         * Легче отладка сбора метрик
      2. Минусы:
         * Менее производительный, т.к. система должна самом обходить все агенты, тратится время на установку соединений.
...
### Ответ:
![](../10-monitoring-02-systems/img/3-1.png)
![](../10-monitoring-02-systems/img/3-2.png)
...
### Ответ:
![](../10-monitoring-02-systems/img/4-1.png)
...
### Ответ:
![](../10-monitoring-02-systems/img/5-1.png)
